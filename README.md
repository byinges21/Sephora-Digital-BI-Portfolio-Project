...
- `docs/sephora_bi_planning_report.md`: full stakeholder, requirements, and strategy planning report.
- `docs/sephora_final_one_page_report.md`: one-page executive summary of methods, findings, and recommendations.
